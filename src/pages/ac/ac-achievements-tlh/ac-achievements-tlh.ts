...
/**
 * Generated class for the AcAchievementsTlhPage page.
 *
...
@Component({
  selector: 'page-ac-achievements-tlh',
  templateUrl: 'ac-achievements-tlh.html',
})
export class AcAchievementsTlhPage {
  tlhData:any = [];
  tlhSelect:any = 'all';
  tlhStatsData:any;
  srkuData:any = [];
