...
@Component({
  ...
  templateUrl: 'ac-distributor-retailer-search.html',
})
export class AcDistributorRetailerSearchPage {
...
dismiss(){
    ...
    initFormData(){
         ...
         return new Promise((resolve,reject)=>{
                ...
                let allSyncTask=[];
                    ...
                    this.cityArr=[];
                    let query="SELECT `id`, `citykabname`, `server_citykabname_id` FROM address_master GROUP BY citykabname" ;
    ...
    let allDistrictData=[];
		...
		let query="SELECT `id`, `citykabname`, `server_citykabname_id` FROM address_master GROUP BY citykabname" ; 
         if(serchKey){
            query="SELECT `id`, `citykabname`, `server_citykabname_id` FROM address_master WHERE citykabname LIKE '%"+serchKey+"%'  GROUP BY citykabname " ;
        }
