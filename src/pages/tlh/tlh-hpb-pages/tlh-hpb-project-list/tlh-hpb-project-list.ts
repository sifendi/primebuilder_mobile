...
import { TlhHpbProjectDetailPage } from "../tlh-hpb-project-detail/tlh-hpb-project-detail";


declare var cordova;

@Component({
  selector: 'tlh-hpb-page-project-list',
  templateUrl: 'tlh-hpb-project-list.html',
})
export class TlhHpbProjectListPage {
  ...
  ionViewDidLoad() {
   ...
   goToProjectDetail(projItem){
       ...
       this.app.getRootNav().push(TlhHpbProjectDetailPage,{
