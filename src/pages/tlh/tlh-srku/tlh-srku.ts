...
@Component({
  selector: 'page-srku',
  templateUrl: 'tlh-srku.html',
})
export class tlhSrkuPage {
  ...
  constructor(private events:Events,private shareS:ShareService,private sqlS:SqlServices,public navCtrl: NavController, public navParams: NavParams) {
    ...
    ionViewDidEnter(){
      ...
      console.log(" master sync status ionViewDidEnter tlh SrkuPage",masterSync);
      if(!masterSync){
        this.firstFunction();      
      }
    }
  ...
  firstFunction() {
      console.log('ionViewDidLoad tlh SrkuPage');
