...
/**
 * Api services for the `App_rds_stock` model.
 */
@Injectable()
export class App_rds_stockApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `App_rds_stock` object.)
   * </em>
   */
   ...
   *  - `result` – `{object}` - 
   */
  public getStock(visit_id: any = {}, brand_id: any = {}, created_date: any = {}, updated_date: any = {}, created_by: any = {}, updated_by: any = {}, limit: any = {}, page: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/app_rds_stock/getStock";
    let _routeParams: any = {};
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof visit_id !== 'undefined' && visit_id !== null) _urlParams.visit_id = visit_id;
   ...
   *  - `result` – `{object}` - 
   */
  public addEditStock(dataArrObj: any = {}, stock_id: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/app_rds_stock/addEditStock";
    let _routeParams: any = {};
    let _postBody: any = {
      dataArrObj: dataArrObj
    };
    let _urlParams: any = {};
    if (typeof stock_id !== 'undefined' && stock_id !== null) _urlParams.stock_id = stock_id;
    let result = this.request(_method, _url, _routeParams, _urlParams, _postBody, null, customHeaders);
    return result;
  }
