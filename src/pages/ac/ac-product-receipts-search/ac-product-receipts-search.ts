...
@Component({
  selector: 'ac-page-product-receipts-search',
  templateUrl: 'ac-product-receipts-search.html',
})
export class AcProductReceiptsSearchPage {
      ...
      if(selFilterData){
        this.prodReceiptFilterArr.receiptType=selFilterData['receiptType'];
            if( selFilterData['receiptType']=='pending' ){
                ...
                this.prodReceiptFilterArr.by="$ac"; 
