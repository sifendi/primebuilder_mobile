...
import { AcHpbProductRequestsDetailsPage } from "../ac-hpb-product-requests-details/ac-hpb-product-requests-details";
import { ALL_MESSAGE } from "../../../../providers/constant";


@Component({
  selector: 'ac-hpb-product-request',
  templateUrl: 'ac-hpb-product-request.html',
})
export class AcHpbProductRequestsPage {
