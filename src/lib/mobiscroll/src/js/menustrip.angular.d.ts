import { EventEmitter, ElementRef, QueryList, MbscBase, Observable } from './frameworks/angular';
...
export declare class MbscMenustrip extends MbscBase {
    ...
    constructor(initialElem: ElementRef, _menustripService: MbscMenustripService);
