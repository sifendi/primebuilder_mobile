...
@Component({
  selector: 'ac-hpb-page-product-requests-details',
  templateUrl: 'ac-hpb-product-requests-details.html',
})
export class AcHpbProductRequestsDetailsPage {
 ...
 ionViewDidLoad() {
        console.log('ionViewDidLoad AcHpbProductRequestsDetailsPage');
        ...
        console.log("productRequestData------->",this.productRequestData);  
