...
import { tlhVisitDetailsPage } from "../tlh-visit-detail-page/tlh-visit-detail-page";
declare var cordova;
...
@Component({
  ...
  templateUrl: 'tlh-distributor-retailer-detail-page.html',
})
export class tlhDistributorRetailerDetailPage {
  page1: any = tlhDistributorVisitListPage;
  page2: any = tlhDistributorDetail; 
  parentThis = this;
  paramsData:any=[];
  selectedIndex:any=0;
  rdsDataArr:any;
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public shareS :ShareService,public appCom:appCommonMethods,public sqlS: SqlServices,public alertCtrl:AlertController,public events:Events,public platform: Platform ) {
    ...
    this.page1 = tlhDistributorVisitListPage;
    this.page2 = tlhDistributorDetail;
  }
...
export class tlhDistributorVisitListPage {
    rdsDataArr: any;
  ...
  goToVisitDetail(visit){
    ...
    t.navCtrl.push(tlhVisitDetailsPage,{
...
export class tlhDistributorDetail {
  paramsRdsData:any=[];
  rdsDataArr:any=[];
