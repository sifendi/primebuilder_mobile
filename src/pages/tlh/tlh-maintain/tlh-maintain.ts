...
@Component({
  ...
  templateUrl: 'tlh-maintain.html',
})
export class tlhMaintainPage {
  ...
  constructor(private events:Events,private shareS:ShareService,private sqlS:SqlServices,public navCtrl: NavController, public navParams: NavParams) {
    ...
    ionViewDidEnter(){
        ...
        console.log(" master sync status ionViewDidEnter tlh MaintainPage",masterSync);
        if(!masterSync){
            this.firstFunction();      
        }
    }
  ...
  firstFunction() {
    console.log('ionViewDidLoad tlh MaintainPage');
