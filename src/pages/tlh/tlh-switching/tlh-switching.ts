...
@Component({
  ...
  templateUrl: 'tlh-switching.html',
})
export class tlhSwitchingPage {
  ...
  constructor(private events:Events,private shareS:ShareService,private sqlS:SqlServices,public navCtrl: NavController, public navParams: NavParams) {
    ...
    ionViewDidEnter(){
      ...
      console.log(" master sync status ionViewDidEnter tlh SwitchingPage",masterSync);
      if(!masterSync){
        this.firstFunction();      
      }
    }
  ...
  firstFunction() {
    console.log('ionViewDidLoad tlh SwitchingPage');
