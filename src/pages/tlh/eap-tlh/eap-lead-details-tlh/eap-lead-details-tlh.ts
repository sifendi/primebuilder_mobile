...
import { EapLeadChatTlh } from "../eap-lead-chat-tlh/eap-lead-chat-tlh";

declare var sessionUserGlobalData;

@Component({
  selector: 'eap-lead-details-tlh',
  templateUrl: 'eap-lead-details-tlh.html',
})
export class EapLeadDetailsTlh {
  busy:any;
...
leadChatShow(leadId,leadData){
    this.navCtrl.push(EapLeadChatTlh,{leadId:leadId,leadData:leadData});
  }
